...
class RewardConfig:
    ...
    num_cpus: int = 1
    num_gpus: float = 0.0  # Ray GPU resource allocation (0.5 means share GPU with another worker)
    # Local reward model settings
    use_local_reward_model: bool = False
    local_reward_model_path: Optional[str] = None
    local_reward_model_type: str = "transformers"  # "transformers" or "vllm"
    local_reward_model_kwargs: dict = field(default_factory=dict)
